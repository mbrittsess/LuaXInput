...
set LuaPInc="C:\Program Files (x86)\Lua\5.2\include"
set LuaPLib="C:\Program Files (x86)\Lua\5.2\lib"
...
if not errorlevel 1 (
%LINK86% /DLL /EXPORT:luaopen_LuaXInput /LIBPATH:%DirectXLib% /LIBPATH:%APILib% /LIBPATH:%SDKLib% /LIBPATH:%CRTLib% /LIBPATH:%LuaPLib% /DEFAULTLIB:lua52.lib /DEFAULTLIB:XInput.lib LuaXInput.obj luaW.obj /OUT:LuaXInput52.dll
del LuaXInput.obj
del luaW.obj
del LuaXInput52.exp
del LuaXInput52.lib
