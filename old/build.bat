...
if not errorlevel 1 (
%LINK86% /DLL /EXPORT:luaopen_LuaXInput /LIBPATH:%DDK%\lib\win7\i386 /LIBPATH:%DDK%\lib\Crt\i386 /LIBPATH:%DirectX%\Lib\x86 /LIBPATH:%LuaP%\lib /DEFAULTLIB:lua5.1.lib /DEFAULTLIB:XINPUT.lib LuaXInput.obj /OUT:LuaXInput.dll
)
