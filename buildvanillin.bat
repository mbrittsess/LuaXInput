...
if not errorlevel 1 (
%LINK86% /DLL /EXPORT:luaopen_LuaXInput /LIBPATH:%DirectXLib% /LIBPATH:%APILib% /LIBPATH:%SDKLib% /LIBPATH:%CRTLib% /LIBPATH:%LuaPLib% /DEFAULTLIB:lua51.lib /DEFAULTLIB:XInput.lib LuaXInput.obj luaW.obj /OUT:gmcl_LuaXInput.dll
del LuaXInput.obj
del luaW.obj
del gmcl_LuaXInput.exp
del gmcl_LuaXInput.lib
)
